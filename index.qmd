...
* Camille Ong, Instruction and Learning Services, SMU Libraries
* Lain Shae Goh, School of Social Sciences
...
**Time** : Fridays, 3:30 - 5:30 PM (All sessions)
...
| 1 | 21 Aug 2026 |[**Introduction to R and RStudio**](01-intro.html) | Learn about setting up RStudio, basic data types and structures in R, and importing data files. |
| 2 | 28 Aug 2026 | [**Data wrangling with tidyverse**](02-tidyverse.html) | Learn about manipulating data with tidyverse, including filtering, selecting, mutating, and grouping data. |
| 3 | 4 Sep 2026 | [**Data visualization and Descriptive Statistics**](03-visualization.html) | Learn about creating visualizations with ggplot2 and calculating descriptive statistics like mean, median, etc. |
| 4 | 11 Sep 2026 | [**Basic Inferential Tests**](04-stats.html) | Learn about conducting t-tests, chi-square tests, ANOVA, and interpreting statistical results in R. |
| 5 | 18 Sep 2026 | [**Regression and Presenting Your Result**](05-more-stats.html) | Learn about regression and various useful packages to generate your result table. |
| \~ | After the workshop |  | [Post-workshop exercises](supp-files/exercises.html) |
:::
...
[**Please complete the pre-workshop survey here**](https://smusg.asia.qualtrics.com/jfe/form/SV_blTI4QJAwGLDfsG) to share your goals and current knowledge. Your input will help to tailor the workshop contents and pace.
