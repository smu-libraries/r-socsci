...
::: {.callout-tip appearance="simple"}
Sound familiar? This is the same comparison a **one-way ANOVA** makes (Session 4) — a one-way ANOVA *is* a linear regression with a single categorical predictor.
:::
...
They all belong to the **general linear model** family; they differ mainly in the *types of variables* they take and the *question they're framed around*. In fact, **t-tests and ANOVA are special cases of linear regression**
