...
resid <- residuals(emanc_country_anova)
...
For every test you run — today's and every one after — the same four-step reflex:


1.  **Define** your research question and its variables. This will guide you in choosing the statistical test.
2.  **Check** — understand what the test assumes and judge whether it's plausible (plots + sample size + common sense).
