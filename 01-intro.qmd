...
Scan the QR Code below to assess your understanding of the basics of R and RStudio, including their purpose, key concepts, and fundamental commands. All questions are required and each is worth 1 mark.

[![Quiz QR Code: <https://forms.cloud.microsoft/r/pvCRpgbQeT>](images/IntroductionToRandRStudioQRCode.png){fig-alt="Quiz QR Code: https://forms.cloud.microsoft/r/pvCRpgbQeT" fig-align="center" width="400"}](https://forms.cloud.microsoft/r/pvCRpgbQeT)
